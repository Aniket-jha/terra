...
const Details = ({propertyDetail}) => {
  ...
  return (
    ...
    <div id="details" className='lg:mx-16 items-center mx-4 py-4 lg:pt-12 lg:pb-12 grid grid-cols-1 gap-x-6 lg:gap-12 lg:grid-cols-2 grid-flow-row  '>
      ...
      <h3 className='font-[NeueMedium]  lg:text-[1.5rem]  text-[.8rem] ' >Walking Distance from Juhu Colleges</h3>
        
        <h1 className='font-[NeueBold]  text-[1.5rem] leading-[1.5rem] lg:leading-[3.5rem]  uppercase lg:text-[2.5rem]' >Spacious Student Studio Rooms, Close to Action of Juhu.</h1>
        <p className='font-[NeueRegular]  text-[0.8rem]  lg:text-[1.1rem] ' > Welcome to Terra, your sunlit haven in the heart of Juhu. Experience the perfect blend of comfort and nature with our cozy, terrarium-inspired living spaces. Each room is bathed in natural light, creating a warm and inviting atmosphere. Terra offers a unique, eco-friendly environment that fosters a sense of tranquility and well-being, making it the ideal retreat for students seeking both comfort and inspiration. </p>
