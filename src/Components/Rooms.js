...
import TerraThreeImage from "../asset/triple.png"
import TerraFourImage from "../asset/quad.png"
...
const Rooms = () => {
  return (
    <div className='lg:mx-16 mx-4 pb-12  ' >
           ...
           <a target='_blank' rel='noreferrer' href="https://firebasestorage.googleapis.com/v0/b/grc-logistics.appspot.com/o/files%2FCopy%20%20%20Terra%20by%20Union%20(1).pdf?alt=media&token=a7876f47-e86b-4c7c-a82e-293918a142d2" download> <button className="uppercase flex items-center justify-center gap-2 lg:gap-3 rounded-lg shadow-md  font-[NeueMedium] ease-in duration-300  text-[12px] md:text-[16px]  hover:shadow-none hover:bg-[#272727] tracking-wider py-[12px] px-[16px] mt-3 md:py-[12px] md:px-[24px] text-[#FFFEFC] bg-[#D64C27]" > What's Included in Rent?  </button></a>
           </div>
    </div>
  )
}
