...
import LastImage from "../asset/last.jpeg"
import TerraceImage from "../asset/terraceImage.jpeg"
import EventSide from "../asset/eventSide.png"
import MainImage from "../asset/mainImage.png"
import GymImage from "../asset/gym.jpeg"
import CanteenImage from "../asset/canteen.jpeg"
          ...
          <div>
            ...
            <div className='lg:grid lg:my-12 mb-3  gap-12 grid-cols-5 grid-flow-col' >
              ...
              <div className='col-span-3 flex items-center justify-end' >
                <img className='w-[800px] my-3 lg:my-0' src={LastImage} />
              </div>
            </div>
